...
# Liste des liens
st.write("""
- [Information](https://aschoolapp.streamlit.app/Informations)
- [Data_Exploration](https://aschoolapp.streamlit.app/Data_Exploration)
- [Data Manipulation](https://aschoolapp.streamlit.app/Data_Manipulation)
- [Driven Décision](https://aschoolapp.streamlit.app/Driven_decision)
- [Data Visualisation](https://aschoolapp.streamlit.app/Data_Visualization)
- [Make Visualisation](https://aschoolapp.streamlit.app/Make_Visualization)
- [Data Modelisation](https://aschoolapp.streamlit.app/Data_Modelisation)
- [Contact Us](https://aschoolapp.streamlit.app/Contact_Us)
- [About Us](https://aschoolapp.streamlit.app/About_Us)
""")
